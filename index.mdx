...
Use this when an AI agent (Claude, ChatGPT, Cursor) should manage social accounts directly via tool calls. SocialAPI exposes a full MCP server with 79 tools and OAuth 2.1 with PKCE for secure agent access.
