...
**Managed connector** - [SocialAPI](https://social-api.ai) handles the Google Cloud OAuth client and Google Business Profile API access for you. No customer-side Google Cloud setup required. See [Platform credentials](/guides/platform-credentials).
