...
| Like comment | Conditional | Accounts connected with Facebook Login only. Instagram Login accounts return `501 resource.not_supported`: read `can_like` on each comment rather than assuming. |
