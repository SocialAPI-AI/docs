...
- **Comment moderation.** Hide sets the comment moderation status to rejected (removes it from public view). Delete removes it permanently. Like is not supported.
