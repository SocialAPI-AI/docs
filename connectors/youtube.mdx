...
- **Permissions.** SocialAPI's managed Google Cloud project already enables the YouTube Data API v3 and requests the OAuth scopes needed to read and manage comments on owned channels. You don't need to set up your own Google Cloud project or apply for any verification. See [Platform credentials](/guides/platform-credentials).
