...
**Coming soon.** LinkedIn Organization Page comment management and publishing is in active development via the LinkedIn Marketing Developer Platform. When it launches, [SocialAPI](https://social-api.ai) will handle the LinkedIn App and platform app review for you. No customer-side LinkedIn Developer registration will be required. See [Platform credentials](/guides/platform-credentials).
