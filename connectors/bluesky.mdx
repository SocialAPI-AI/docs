...
SocialAPI validates the app password and connects the account. No redirect, no second call.
...
DMs work only with an app password created with the direct messages option enabled. That flag is checked when you connect.
