...
SocialAPI's managed TikTok Developer App already requests these scopes on your behalf: `user.info.basic`, `video.publish`, `video.upload`. You don't need to register with TikTok for Developers. See [Platform credentials](/guides/platform-credentials).
