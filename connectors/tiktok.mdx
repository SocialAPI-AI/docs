...
**Managed connector** — SocialAPI handles the TikTok Developer App and platform app review for you. No customer-side TikTok for Developers registration required. See [Platform credentials](/guides/platform-credentials).
...
- **Permissions** - SocialAPI's managed TikTok Developer App already requests these scopes on your behalf: `user.info.basic`, `video.publish`, `video.upload`. You don't need to apply for any platform app review. See [Platform credentials](/guides/platform-credentials).
