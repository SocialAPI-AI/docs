...
**Coming soon.** Google Business Profile publishing is in active development. This page documents the planned API shape; calls to create, update, or delete Google posts will return `501` until the connector launches. See [connectors/google-reviews](/connectors/google-reviews) for status.
