...
This single scope covers all GBP API operations (listing locations, creating and managing local posts, reading and replying to reviews, and answering Q&A questions).
