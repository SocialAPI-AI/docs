...
All four scopes are requested during the OAuth flow. If any scope is missing or not approved in your Meta App Dashboard, the corresponding API calls will return a `400` or `403` from the Threads Graph API.
