...
SocialAPI's managed LinkedIn Developer app requests the following scopes on your behalf during the OAuth flow. This is informational — you do not need to configure anything.
