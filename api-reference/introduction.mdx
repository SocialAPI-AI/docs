...
|---|---|---|
| Accounts | `GET /accounts`, `POST /accounts/connect`, `POST /oauth/exchange`, `DELETE /accounts/:id`, `GET /accounts/:id/creator-info`, `GET /accounts/:id/pages`, `PATCH /accounts/:id/pages/:pageId`, `GET /accounts/:id/limits` | Connect, list, and disconnect social accounts; manage pages and per-account creator info |
