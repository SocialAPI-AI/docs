---
title: Cursor
description: Connect SocialAPI to Cursor via config file or Settings UI.
---
...
When you first use a [SocialAPI](https://social-api.ai) tool, Cursor discovers the OAuth metadata, opens your browser for authorization, and exchanges the code using PKCE. The token is stored and refreshed automatically.
...
Open **Agent** mode in Cursor. [SocialAPI](https://social-api.ai) tools appear under **Available Tools** and are invoked automatically when relevant. You can also mention a tool by name in your prompt.
