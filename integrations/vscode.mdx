...
description: Connect SocialAPI to VS Code with GitHub Copilot via config file or Command Palette.
---
...
[SocialAPI](https://social-api.ai) tools are then available in **Copilot Chat** (Agent mode).
