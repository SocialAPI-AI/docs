...
|---|---|---|---|---|---|---|---|---|---|---|---|
| Instagram | yes | yes | yes | yes | Conditional | yes | yes | yes | - | yes | yes |
...
| LinkedIn Organization | Beta | Beta | Beta | Beta | Beta | Beta | - | - | - | - | Beta |
| Google | yes | - | - | - | - | - | - | - | yes | - | yes |
| Telegram | - | - | - | - | - | - | - | yes | - | - | - |
| WhatsApp | - | - | - | - | - | - | - | yes | - | - | - |
| Trustpilot | - | - | - | - | - | - | - | - | Soon | - | - |
| Zalo | yes | - | - | - | - | - | - | yes | - | - | yes |
| Bluesky | yes | yes | yes | yes | - | Conditional | - | yes | - | yes | yes |
| Pinterest | yes | - | - | - | - | - | - | - | - | - | yes |

**Legend:** yes = supported · Conditional = supported under specific conditions (e.g., on own replies only) · Beta = live in beta, access on request (see the [LinkedIn connector](/connectors/linkedin#linkedin-organization-pages-beta)) · Soon = coming soon · - = not supported by platform
...
When you call an endpoint for a capability a platform does not support, [SocialAPI](https://social-api.ai) returns `501`:
