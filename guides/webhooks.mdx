...
| `dm.status.sent` | inbox | A direct message you sent was accepted by the platform |
| `dm.status.delivered` | inbox | A direct message you sent was delivered to the recipient |
| `dm.status.read` | inbox | A direct message you sent was read by the recipient |
| `dm.status.failed` | inbox | A direct message you sent failed to deliver |
...
You can subscribe to any combination. Pass all twenty to receive everything.
