...
description: "How to authenticate API requests with your SocAPI key."
---
...
Keys are issued from your workspace dashboard at [socapi.ai](https://socapi.ai). Each key is tied to a plan tier that determines your daily call limit and available features.
