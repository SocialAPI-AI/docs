...
<Note>
  The bulk-import pre-check path uses a different code: `billing.post_limit`. This is only relevant if you use the import endpoint to pre-validate a batch of posts before committing them.
</Note>
