...
[SocialAPI.AI](https://social-api.ai) uses **resource-based** limits. Every plan gives you a fixed number of connected accounts, posts per month, interactions per month, and media storage. All plans have access to all platforms, DMs, and features - plans differ only by resource limits.
